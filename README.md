...
Se scrivi una richiesta come `Jarvis calcola il percorso migliore` allegando uno screenshot con indirizzi, rispondendo a un messaggio che contiene lo screenshot oppure scrivendo gli indirizzi in testo, Jarvis prova a:
